function obj2_exploratory_pca(inputXlsx, sheetName)
% obj2_exploratory_pca
%
% Exploratory principal component analysis (PCA) of sample-level
% hyperspectral data for the grape dataset.
%
% This workflow:
%   1. reads the master Excel matrix,
%   2. extracts FX10 and FX17 spectral blocks,
%   3. computes PCA for RAW and SNV-preprocessed spectra,
%   4. generates manuscript-oriented score, loading, and mean/difference plots,
%   5. exports an Excel summary and a run log.
%
% Deliverables:
%   - PCA score plots aligned with manuscript Figure 3
%   - loading plots aligned with manuscript Figure 4
%   - mean/difference spectra plots aligned with manuscript Figure 5
%   - supplementary diagnostic score plots
%   - Excel summary with:
%       * explained variance (PC1–PC5)
%       * ANOVA on PC1/PC2 scores
%       * top loading wavelengths
%
% Inputs:
%   inputXlsx  - path to the master Excel file
%   sheetName  - worksheet name (optional). If omitted or empty, 'Matriz'
%                is used.
%
% Output:
...
%       - timestamped PCA summary Excel file
%       - manuscript-oriented figures (.png and .fig)
%
% Notes:
%   - PCA is computed by SVD on mean-centred data.
